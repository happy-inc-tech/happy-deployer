...
StorageService = __decorate([
    inversify.injectable(),
    __param(0, inversify.inject(CacheService$1)),
...
LoggerService = __decorate([
    inversify.injectable(),
    __param(0, inversify.inject(StorageService$1)),
...
ServerService = __decorate([
    ...
    __param(2, inversify.inject(LoggerService$1)),
    __param(3, inversify.inject(ProcessService$1)),
    __param(4, inversify.inject(ReleaseService$1)),
    __metadata("design:paramtypes", [OsOperationsService$1,
        StorageService$1,
        LoggerService$1,
        ProcessService$1,
...
TaskService = __decorate([
    inversify.injectable(),
    __param(0, inversify.inject(ServerService$1)),
    __param(1, inversify.inject(LoggerService$1)),
    __param(2, inversify.inject(ProcessService$1)),
...
CoreTasksService = __decorate([
    inversify.injectable(),
    __param(0, inversify.inject(TaskService$1)),
...
HappyDeployer = __decorate([
    inversify.injectable(),
    __param(0, inversify.inject(ServerService$1)),
    __param(1, inversify.inject(TaskService$1)),
    __param(2, inversify.inject(CoreTasksService$1)),
...
function createContainer() {
    container = new inversify.Container({ defaultScope: 'Singleton', autoBindInjectable: true });
...
exports.installDepsTask = installDepsTask;
